 ...
 * @author otavio
 */
@WebServlet(name = "TrazerLivro", urlPatterns = {"/TrazerLivro"})
public class TrazerLivro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Livro livro = model.buscarIndex(index);
        
        this.index = index;
        
        request.setAttribute("livro", livro);
        
        request.getRequestDispatcher("WEB-INF/editarLivro.jsp").
