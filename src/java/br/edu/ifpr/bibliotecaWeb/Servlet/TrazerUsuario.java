 ...
 * @author otavio
 */
@WebServlet(name = "AlterarUsuario", urlPatterns = {"/TrazerUsuario"})
public class TrazerUsuario extends HttpServlet {
    int index;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario usuario =model.buscarIndex(index);
        
        this.index = index;
        
        request.setAttribute("usuario", usuario);
        
        request.getRequestDispatcher("WEB-INF/editarUsuario.jsp").
